...
function network_plot_gmt(region::String, cell_size::Float64, minimum_magnitude::Int64, marker_size::Float64, ratio_for_z::Int64, perspective::Tuple{Int64,Int64}, quality::Int64, colorbar_info::Vector{Any})
    """
    Description:
    ...
    grdview!(relief_map, proj=:merc, surftype=(image=quality,), 
                cmap=C_map, zsize=1.0, alpha=25 ,yshift=z_ratio-0.3, view=perspective,
...
##############################################################################################################################################
# function network_plot_gmt_Vrancea(region::String, cell_size::Float64, minimum_magnitude::Int64, marker_size::Float64, ratio_for_z::Int64, perspective::Tuple{Int64,Int64}, quality::Int64, colorbar_info::Vector{Any})
#     """
#     Description:
#     Takes in the region, cell_size and minimum_magnitude and plots with GMT
#         a 3D visualization of the earthquake network with the above specifications, 
